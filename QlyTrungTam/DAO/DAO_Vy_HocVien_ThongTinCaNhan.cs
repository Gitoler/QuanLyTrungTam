...
{
    class DAO_Vy_HocVien_ThongTinCaNhan
    {
        private static DAO_Vy_HocVien_ThongTinCaNhan instance;
        public static DAO_Vy_HocVien_ThongTinCaNhan Instance
        {
            get
            {
                if (instance == null) instance = new DAO_Vy_HocVien_ThongTinCaNhan();
                return instance;
            }
        ...
        private DAO_Vy_HocVien_ThongTinCaNhan() { }
    }
}
